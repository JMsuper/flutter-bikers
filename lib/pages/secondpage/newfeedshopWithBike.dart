...
class NewFeedShopWithBike extends StatefulWidget {
  @override
  _NewFeedShopWithBikeState createState() => _NewFeedShopWithBikeState();
}

class _NewFeedShopWithBikeState extends State<NewFeedShopWithBike> {
...
""";
  ...
  void didChangeDependencies() {
    ...
    contentController.text = initialString;
  }
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: GestureDetector(
                                onTap: () async {
                                  int returnNum = await CategorySelctor
                                      .selectCategoryWithBike(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: GestureDetector(
                                onTap: () async {
                                  int returnNum =
                                      await CategorySelctor.selectRegion(
